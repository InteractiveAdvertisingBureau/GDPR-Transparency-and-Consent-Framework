  ...
  es: {
    ...
    purposes: {
      ...
      purpose1: {
        ...
        description: 'El almacenamiento de la información o el acceso a la información que ya está almacenada en el dispositivo del usuario, como el acceso a identificadores de publicidad u otros identificadores de dispositivo, o el uso de cookies o tecnologías similares.'
      },
      purpose2: {
        menu: '',
      ...
      purpose3: {
        ...
        description: 'La recogida de información y la combinación con información previamente recogida, para seleccionar y enviar anuncios, y para calcular el envío y la eficacia de dichos anuncios. Esto incluye usar información previamente recogida sobre los intereses de un usuario para seleccionar anuncios, tratar datos sobre los anuncios que se han mostrado, con qué frecuencia se han mostrado, cuándo y dónde se han mostrado y si realizaron alguna acción relacionada con el anuncio, incluido, por ejemplo, hacer clic en un anuncio o hacer una compra.'
      },
      purpose4: {
        menu: '',
        title: 'Selección, envío, informe de contenido',
        description: 'La recogida de información y la combinación con información previamente recogida, para seleccionar y enviar contenido, y para calcular el envío y la eficacia de dicho contenido. Esto incluye usar información previamente recogida sobre los intereses de un usuario para seleccionar contenido, tratar datos sobre qué contenido se ha mostrado, con qué frecuencia y durante cuánto tiempo se ha mostrado, cuándo y dónde se ha mostrado y si realizaron alguna acción relacionada con el contenido, incluido, por ejemplo, hacer clic en el contenido.'
      },
      purpose5: {
        menu: '',
        title: 'Cálculo',
        description: 'La recogida de información sobre el uso de contenido por parte de un usuario y la combinación con información previamente recogida, usada para calcular, entender e informar sobre la utilización del contenido por parte de un usuario.'
      },
      customPurpose1: {
        menu: '',
        title: '',
