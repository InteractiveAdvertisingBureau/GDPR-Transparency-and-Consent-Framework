...
## Specifications
 - [CMP API](./CMP_API_spec_v2.0.md)
 - [CMP List](./CMP_List_spec_v2.0.md)
 - [Global Vendor List](./Global_Vendor_List_spec_v2.0.md)
 - [In-App](./In-App_spec_v2.0.md)
 - [TC string](./TC_String_spec_v2.0.md)

## Implementation Guidelines

 - [Implementation Guidelines](./Implementation_Guidelines_v2.0.md)
...
IAB Europe established the TCF to support compliance with the GDPR in the context of digital advertising. This framework is built on four components: a [Global Vendor List (GVL)](./Global_Vendor_List_spec_v2.0.md), a Transparency and Consent String (TC String), an API for Consent Management Providers (CMPs) to create and process the TC String, and the Policies that govern how the TCF is used.
...
Resources including policy FAQ, [Global Vendor List](./Global_Vendor_List_spec_v2.0.md), and [CMP List](./Cmp_List_spec_v2.0.md) can be found at [iabeurope.eu/tcf](https://iabeurope.eu/tcf).
