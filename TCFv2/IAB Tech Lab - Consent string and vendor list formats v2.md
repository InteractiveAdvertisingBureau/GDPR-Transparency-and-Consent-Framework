  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The last ID of the inclusive contiguous ascending-order series of
        Vendor IDs started with StartOrOnlyVendorId but only if that series
        has a cardinality greater than 1, otherwise this field is omitted. Note that _contiguous_ above permits encoding ranges that cover gaps in the GVL registrations unlike other range encodings in this specification. For example, to encode a restriction for vendors [12, 15, 18, 23] if vendor IDs 13-14, 16-17, and 19-22 are not in the GVL, a range entry of 12-23 is permitted. 
      </td>
      <td>
        The end of the series of Vendor IDs – this is omitted if
        <code>IsARange=0</code>.
