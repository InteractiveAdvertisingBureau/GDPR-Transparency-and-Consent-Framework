...
* In the case where gdprApplies is set to 1, Vendors shall always consider that GDPR applies. 
* In the case where gdprApplies is set to 0, Vendors may put in place additional measures to verify whether or not GDPR applies on a case-by-case basis and, based on that assessment, handle the tcString accordingly, if the tcString is part of the transaction. 
